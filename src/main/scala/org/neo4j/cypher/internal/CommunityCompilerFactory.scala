...
class CommunityCompilerFactory(
  ...
  override def supportsAdministrativeCommands(): Boolean = false
  ...
  override def createCompiler(
    ...
    val runtime = CommunityRuntimeFactory.getRuntime(cypherRuntime, plannerConfig.useErrorsOverWarnings())
