...
import org.neo4j.cypher.internal.runtime.core.pipes.TransactionPipeWrapper.CypherRowEntityTransformer
import org.neo4j.cypher.internal.runtime.core.pipes.TransactionPipeWrapper.assertTransactionStateIsEmpty
import org.neo4j.cypher.internal.runtime.core.pipes.TransactionPipeWrapper.logError
...
sealed trait TransactionStatus {
  ...
  def profileInformation: RuntimeProfileInformation
}
...
case object NotRun extends TransactionStatus {
  ...
  override def profileInformation: RuntimeProfileInformation = null
}
