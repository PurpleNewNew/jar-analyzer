...
import org.neo4j.cypher.internal.runtime.core.DelegatingOperations
import org.neo4j.cypher.internal.runtime.core.DelegatingQueryContext
import org.neo4j.cypher.internal.runtime.core.DelegatingReadOperations
...
class Profiler(val dbmsInfo: DbmsInfo, stats: RuntimeProfileInformation) extends PipeDecorator {
  outerProfiler =>

  def withProfileInformation(profileInformation: RuntimeProfileInformation): Profiler =
