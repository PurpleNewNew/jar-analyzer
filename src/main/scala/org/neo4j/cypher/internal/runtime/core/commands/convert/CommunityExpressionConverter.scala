...
import org.neo4j.cypher.internal.runtime.core.commands.convert.PatternConverters.ShortestPathsConverter
import org.neo4j.cypher.internal.runtime.core.commands.expressions
import org.neo4j.cypher.internal.runtime.core.commands.expressions.InequalitySeekRangeExpression
import org.neo4j.cypher.internal.runtime.core.commands.expressions.PointBoundingBoxSeekRangeExpression
import org.neo4j.cypher.internal.runtime.core.commands.expressions.PointDistanceSeekRangeExpression
import org.neo4j.cypher.internal.runtime.core.commands.expressions.PropertiesUsingCachedExpressionsFunction
import org.neo4j.cypher.internal.runtime.core.commands.expressions.VariableCommand
...
import org.neo4j.cypher.internal.runtime.core.commands.values.TokenType.PropertyKey
import org.neo4j.cypher.internal.runtime.core.commands.values.UnresolvedRelType
import org.neo4j.cypher.internal.runtime.core.pipes
...
case class CommunityExpressionConverter(
  ...
  override def toCommandProjection(
    ...
    projections
      ...
      .map(CoreCommandProjection.apply)
  }
