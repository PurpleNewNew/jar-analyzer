    ...
    public static List<LuceneSearchResult> searchLucene(String input) {
        ...
        try {
            ...
            if (LuceneSearchForm.useContains()) {
                internalResult = IndexEngine.searchNormal(input, LuceneSearchForm.useCaseSensitive());
            } else if (LuceneSearchForm.useRegex()) {
                internalResult = IndexEngine.searchRegex(input, LuceneSearchForm.useCaseSensitive());
            } else {
