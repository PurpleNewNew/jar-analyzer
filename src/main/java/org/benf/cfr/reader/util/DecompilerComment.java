...
public class DecompilerComment implements Dumpable {
    ...
    public static final DecompilerComment AGGRESSIVE_EXCEPTION_VERY_AGG = new DecompilerComment("WARNING - combined exceptions agressively - possible behaviour change.", false);
    ...
    public static final DecompilerComment DROP_EXCEPTIONS = new DecompilerComment("WARNING - dropped exception handling.  Behaviour almost certainly changed.", false);
    public static final DecompilerComment PARAMETER_CORRUPTION = new DecompilerComment("WARNING - Possible parameter corruption", false);
    public static final DecompilerComment TRY_BACKEDGE_REMOVED = new DecompilerComment("WARNING - Removed back jump from a try to a catch block - possible behaviour change.", false);
    public static final DecompilerComment LOOPING_EXCEPTIONS = new DecompilerComment("WARNING - Removed try catching itself - possible behaviour change.", false);
    ...
    public static final DecompilerComment CLASS_RENAMED = new DecompilerComment("Inner class renamed, behaviour may change", false);
    ...
    public static final DecompilerComment DYNAMIC_CONSTANTS = new DecompilerComment("Uses jvm11+ dynamic constants - pseudocode provided - see https://www.benf.org/other/cfr/dynamic-constants.html", false);
    ...
    private final DecompilationQuality quality;
    ...
    public DecompilerComment(String comment) {
        ...
        this.quality = DecompilationQuality.CLEAN;
    }
    ...
    public DecompilerComment(String comment, boolean failed) {
        ...
        this.failed = failed;
        this.exception = false;
        this.quality = failed ? DecompilationQuality.FAILED : DecompilationQuality.DEGRADED;
    }
    ...
    public DecompilerComment(String comment, Exception e) {
        ...
        this.failed = true;
        this.exception = true;
        this.quality = DecompilationQuality.FAILED;
    }
    ...
    public boolean isDegraded() {
        return quality != DecompilationQuality.CLEAN;
    }
