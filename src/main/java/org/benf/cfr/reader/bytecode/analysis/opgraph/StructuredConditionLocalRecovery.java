...
public final class StructuredConditionLocalRecovery {
    ...
    private static final class ConditionLocalAliasCleaner implements org.benf.cfr.reader.bytecode.analysis.opgraph.op4rewriters.transformers.StructuredStatementTransformer {
        @Override
    ...
    private static final class DefinitionIfAssignmentRestorer implements org.benf.cfr.reader.bytecode.analysis.opgraph.op4rewriters.transformers.StructuredStatementTransformer {
        ...
        private void restoreLiftablePrefix(StructuredStatement targetStatement,
            ...
            for (LiftablePrefixCandidate candidate : candidates) {
                ...
                if (usesConditionDefinedLocal(targetStatement, lifted.getrValue())) {
                    return;
                }
