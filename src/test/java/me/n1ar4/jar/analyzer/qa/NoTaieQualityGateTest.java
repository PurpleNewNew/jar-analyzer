...
public class NoTaieQualityGateTest {
    ...
    private static final String GADGET_ITER_PROP = "bench.no_taie.gate.gadget.iter";
    private static final String GADGET_MIN_HIT_PROP = "bench.no_taie.gate.gadget.minHit";
    private static final String GADGET_MAX_P95_PROP = "bench.no_taie.gate.gadget.maxP95Ms";

    private static final String NAV_ITER_PROP = "bench.no_taie.gate.nav.iter";
    private static final String NAV_MIN_HIT_PROP = "bench.no_taie.gate.nav.minHit";
    private static final String NAV_MAX_P95_PROP = "bench.no_taie.gate.nav.maxP95Ms";

    private static final String WEB_ITER_PROP = "bench.no_taie.gate.web.iter";
    private static final String WEB_SCENARIOS_PROP = "bench.no_taie.gate.web.scenarios";
    private static final String WEB_MAX_BUILD_P95_PROP = "bench.no_taie.gate.web.maxBuildP95Ms";
    private static final String WEB_MAX_PEAK_HEAP_MIB_PROP = "bench.no_taie.gate.web.maxPeakHeapMiB";

    private static final String DEFAULT_WEB_SCENARIOS = "framework-stack,ssm-war,ssm-project-mode,springboot-fatjar";

    @Test
    @SuppressWarnings("all")
    public void benchmarkPhase0QualityGate() throws Exception {
        Assumptions.assumeTrue(Boolean.getBoolean(ENABLE_PROP),
                "set -D" + ENABLE_PROP + "=true to enable no-taie quality gate");
        ...
        NoTaieBaselineBenchTest.BaselineResult web =
                NoTaieBaselineBenchTest.runBaseline(webIterations, webScenarios, false);
    ...
    private static void writeGateReport(GadgetRouteCoverageBenchTest.BenchmarkResult gadget,
        ...
        BenchReportWriter.writeMarkdown("no-taie-quality-gate.md", "No Tai-e Quality Gate", lines);
    }

    private static Set<String> resolveWebScenarios(String raw) {
        Set<String> selected = NoTaieBaselineBenchTest.resolveScenarioSelection(raw);
        if (!selected.isEmpty()) {
            return selected;
        }
        Set<String> defaults = new LinkedHashSet<>();
        defaults.addAll(NoTaieBaselineBenchTest.resolveScenarioSelection(DEFAULT_WEB_SCENARIOS));
        return defaults;
    }
