...
def create_release_dirs():
    ...
    base = "jar-analyzer-{}".format(VERSION)
    return {
...
def main() -> int:
    ...
    for flavor, target_dir in release_dirs.items():
        ...
        copy_start_files(target_dir, flavor)
